...
parser = argparse.ArgumentParser(description='Chatbot that generates responses based on a system and user prompt.')
parser.add_argument('-s', '--system', type=str, help='System prompt', default="You are a poetic assistant, skilled in explaining complex programming concepts with creative flair.")
parser.add_argument('-v', '--user', type=str, help='User prompt', default=None)
